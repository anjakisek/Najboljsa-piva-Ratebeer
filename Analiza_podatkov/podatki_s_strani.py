...
iskanje = re.compile(r'<a style="font-size:20px; font-weight:bold;" href="(?P<naslov>.*?/)\d{2,11}/"'
...
def proba_posamezno():
    besedilo = orodja.preberi('{}html2/stran{}.txt'.format(lokacija, 213))
    for i in re.finditer(iskanje_kalorije, besedilo):
        print(i.groupdict())
#print(proba_posamezno())
...
def shrani_drugo_tabelo():
    ...
    orodja.shrani_csv(pivo, ['naslov', 'pivovarna', 'mesto', 'drzava', 'stil', 'alkohol'], 'pivo_csv')
